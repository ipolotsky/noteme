...
def settings_kb(user: User, lang: str) -> InlineKeyboardMarkup:
    spoiler_status = (
        t("settings.enabled", lang) if user.spoiler_enabled else t("settings.disabled", lang)
    )
    ...
    return InlineKeyboardMarkup(
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(
                    text=t(
                        "settings.notify_day_before_time",
                        lang,
                        time=user.notify_day_before_time.strftime("%H:%M"),
                    ),
            ...
            [
                InlineKeyboardButton(
                    text=t(
                        "settings.notify_week_before_time",
                        lang,
                        time=user.notify_week_before_time.strftime("%H:%M"),
                    ),
            ...
            [
                InlineKeyboardButton(
                    text=t(
                        ...
                        lang,
                        time=user.weekly_digest_time.strftime("%H:%M"),
                    ),
